...
subplot(4,4,16) 
 ...
 ylim([-0.2 1.2])
  xlim([0 1.5])
%%itreration convergence plot
  figure(3)
  Pe12p5normu = [0.0202,0.0029,0.0012,8.2261e-04];
  Pe12p5up = [0.1339,0.0064,0.0050, 0.0029];
  
  Pe125normu = [0.0880, 0.0149,0.0067,0.0056,0.0057,0.0041,0.0034];
  Pe125up = [0.0522,0.0107,0.0077, 0.0050,0.0026,0.0018,8.4126e-04];
  
  SQPe125normu = [0.032193262368686,0.006314845333216,0.003799746569498,0.002832801448529,0.001390820334128,8.302718357212552e-04];
  SQPe125up = [0.109295787604723,0.020996318364634,0.019659255343275, 0.027490965702257,0.015281326960724,0.009055199546253];
  
  SQPe12p5normu = [0.005030781297844, 0.003095289002992,0.002932471984932,6.427998464328565e-04];
  SQPe12p5up = [0.138842620457101,0.075200561395091,0.087178719897405, 0.021366276953504];
  


  plot(1:7,Pe125normu,'bo-');
  hold on
  plot(1:6,SQPe125normu,'r*-');
  %   figure(4)
  %   plot(1:4,SQPe12p5normu,'r*-');
  %   hold on
  %   plot(1:4,Pe12p5normu,'bo-');
  %   figure(5)
  %   plot(1:4,Pe12p5up,'bo-');
  %   hold on
  %   plot(1:4,SQPe12p5up,'r*-');
  figure(6)
  plot(1:7,Pe125up,'bo-');
  hold on
  plot(1:6,SQPe125up,'r*-');
